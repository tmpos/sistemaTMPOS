...
export async function imprimirReporte(datosLoL, datosEmpresa, silent, visible, show) {
  /************************************************************/
  // Ajustar los datos que recibimos de datosLoL
  const datosDD = JSON.parse(datosLoL)
  // const pagoDatos = datosDD.datos;
  const totales = datosDD // Asumiendo que los totales vienen en este campo
  /************************************************************/
  ...
  const htmlContent = `
    ...
    <body>
        <div class="ticket">
            ...
            <!-- Nueva sección de la tabla para los totales -->
            <div class="bordeado" style="text-align:center;padding:3px;">
                ...
                <table>
                    ...
                    <tr>
                        <td>Ventas</td>
                        <td>${datosConfiguracion.simbolo}${totales.ventas.toFixed(2)}</td>
                    </tr>
                    <tr>
                        <td>Ganancias</td>
                        <td>${datosConfiguracion.simbolo}${totales.ganancias.toFixed(2)}</td>
                    </tr>
                    <tr>
                        <td>Impuestos</td>
                        <td>${datosConfiguracion.simbolo}${totales.impuestos.toFixed(2)}</td>
                    </tr>
                    <tr>
                        <td>Gastos</td>
                        <td>${datosConfiguracion.simbolo}${totales.gastos.toFixed(2)}</td>
                    </tr>
                    <tr>
                        <td>Devoluciones</td>
                        <td>${datosConfiguracion.simbolo}${totales.devoluciones.toFixed(2)}</td>
                    </tr>
                    <tr>
                        <td>Taller</td>
                        <td>${datosConfiguracion.simbolo}${totales.taller.toFixed(2)}</td>
                    </tr>
                    <tr>
                        <td>Cuentas por Cobrar</td>
                        <td>${datosConfiguracion.simbolo}${totales.cuentas_cobrar.toFixed(2)}</td>
                    </tr>
                </table>
            </div>
        </div>
