...
export async function imprimirInventario(datosLoL, datosEmpresa, silent, visible, show) {
  /************************************************************/
    ...
    .map((producto) => {
      return `
        <tr>
            ...
            <td style="text-align:left; padding: 5px;">${producto.stock}</td>
            <td style="text-align:left; padding: 5px;">${producto.precio_compra}</td>
            <td style="text-align:left; padding: 5px;">${producto.precio_venta}</td>
        </tr>
    `
    })
    .join('')
