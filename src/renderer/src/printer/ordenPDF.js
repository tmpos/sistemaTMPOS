...
export async function pdfOrdenCarta(factura, cliente, datosEmpresa, impresora) {
...
<body class="p-4 text-xs font-sans">
  <div class="max-w-3xl mx-auto  p-4">
    ...
    <div class="flex justify-between items-start">
      ...
      <div class="text-right space-y-1 border  px-2 py-1  rounded-md">
        <table class="text-right text-sm w-full total"  >
          ...
          <h2 class="text-center font-bold mt-4 border-y border-black py-1 bg-blue-400 text-white rounded-md">
    ...
    <div class=" w-1/3">
        ...
        <div class=" w-1/3 rounded-lg border shadow-sm">
          <table class="text-right text-sm w-full total"  >
            ...
            <tr class="font-bold"><td class=" px-1">TOTAL</td><td class=" px-1">${formatoMonedaRD(datosOrden.total)}</td></tr>
          </table>
        </div>
      </div>
    ...
    <div class="mt-4 text-justify">
      ...
      <div class="bg-blue-100 border-2 border-blue-400 rounded-lg p-2 mt-4">
        <p class="font-bold text-center text-blue-800">
          ℹ️ ESTA ES UNA ORDEN DE TRABAJO - NO DESCUENTA STOCK ℹ️
        </p>
        <p class="text-xs text-center text-blue-700 mt-1">
  ...
  win.webContents.on('did-finish-load', async () => {
    const pdfPath = path.join(app.getPath('downloads'), `orden_${datosOrden.no_orden}.pdf`)
  ...
  console.log('✅ Orden Carta A4 cargada en ventana')
}
