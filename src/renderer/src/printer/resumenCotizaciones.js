...
export async function imprimirReporteCotizaciones(datosLoL, datosEmpresa, silent, visible, show) {
  /************************************************************/
  ...
  const productosHTML = datosArray
    .map((factura) => {
      return `
        <tr>
            <td style="text-align:left; padding: 5px;">${factura.no_cotizacion}</td>
            <td style="text-align:left; padding: 5px;">${factura.nombre_cliente}</td>
            <td style="text-align:left; padding: 5px;">${factura.fecha_emision}</td>
            <td style="text-align:left; padding: 5px;">${factura.hora}</td>
            <td style="text-align:left; padding: 5px;">${factura.estado_cotizacion}</td>
