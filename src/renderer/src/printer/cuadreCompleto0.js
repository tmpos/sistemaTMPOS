...
*/
  ...
  const horaInicialM = jsonData['registrocaja'].filter((fact) => fact.almacen === empresa.nombre)
    ...
    : ''
            ...
            <table style="font-size:20px;font-weight:bold">
                <tr>
                    ...
                    <td class="cantidad2 right-align" style="font-size: 1.5em !important">${datosConfiguracion.simbolo}${Number(efectivo) + Number(inicioCaja) - gastos || 0.0}</td>
                </tr>
                <tr>
     ...
     monedas
       ? `<tr>
        ...
        <td class="cantidad2 right-align" style="font-size: 1.5em !important">
            ${(() => {
              const totalCaja = Number(efectivo) + Number(inicioCaja) - gastos
