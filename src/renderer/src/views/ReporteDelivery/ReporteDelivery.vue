...
<template>
  <main class="content-wrapper bg-gray-50 min-h-screen">
    <div class="w-full px-4 py-6">
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Reporte por Delivery</h1>
        <p class="text-gray-600 mt-1">Análisis de entregas y desempeño de delivery</p>
      </div>

      <Card class="shadow-lg">
        <template #content>
          <div class="text-center py-12">
            <i class="pi pi-car text-gray-300 text-6xl mb-4"></i>
            <h2 class="text-xl font-semibold text-gray-700 mb-2">Reporte en Desarrollo</h2>
            <p class="text-gray-500 mb-6">Este reporte estará disponible próximamente con análisis detallado de entregas.</p>
