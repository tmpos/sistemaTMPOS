...
<template>
  <main class="content-wrapper bg-gray-50 min-h-screen">
    <div class="w-full px-4 py-6">
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Reporte por TÃ©cnicos</h1>
        <p class="text-gray-600 mt-1">AnÃ¡lisis de servicios tÃ©cnicos</p>
      </div>

      <Card class="shadow-lg">
        <template #content>
          <div class="text-center py-12">
            <i class="pi-cog text-gray-300 text-6xl mb-4"></i>
