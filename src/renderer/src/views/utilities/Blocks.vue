...
const block1 = ref(` <div class="grid grid-nogutter surface-section text-800">
    <div class="col-span-12 md:col-6 p-6 text-center md:text-left flex align-items-center">
        <section>
    ...
    <div class="col-span-12 md:col-6 overflow-hidden">
...
const block2 = ref(` <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-center">
    ...
    <div class="grid">
        <div class="col-span-12 md:col-4 mb-4 px-5">
        ...
        <div class="col-span-12 md:col-4 md:mb-4 mb-0 px-3">
            <span class="p-3 shadow-2 mb-3 inline-block surface-card" style="border-radius: 10px">
...
const block3 = ref(` <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
    ...
    <div class="grid">
        <div class="col-span-12 lg:col-4">
...
const block7 = ref(` <div class="surface-ground px-4 py-5 md:px-6 lg:px-8">
    <div class="grid">
        <div class="col-span-12 md:col-6 lg:col-3">
