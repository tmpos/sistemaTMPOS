...
import { peticionesFetch, nfecha, envioElectron, encryptarPassword, peticionesFetchOffline, arrayToObjetoFromTablaOffline, crearTablaSiNoExisteOffline } from '../../funciones/funciones.js';
...
const fetchData = async () => {
    ...
    const response = await peticionesFetchOffline('datosVentasPorRango', `${nfecha('year')}-${nfecha('mes')}-01 00:00:01`,fechaFinN);
            ...
            <div class="card-body">
              <div class="grid grid-cols-12 gap-4 text-center">
                <div class="md:col-span-4 offset-md-4">
                  <label for="mesSelect" class="form-label">Datos del mes de {{nfecha('mesletra')}}</label>
