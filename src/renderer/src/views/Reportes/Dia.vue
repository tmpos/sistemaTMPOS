...
import { peticionesFetch, nfecha, envioElectron, enviarDatosLocalStorage, convertirAFechaTimestamp, esFechaEnRango, encryptarPassword, peticionesFetchOffline, arrayToObjetoFromTablaOffline, crearTablaSiNoExisteOffline } from '../../funciones/funciones.js';
...
const fetchData = async () => {
    ...
    const response = await peticionesFetchOffline('datosVentasPorRango', `${nfecha('fechaAmericana')} 00:00:01`,fechaFinN);
